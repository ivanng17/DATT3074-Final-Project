//All the data in the arrays comes from Climate Data.ca: https://climatedata.ca/
//Setting all of the arrays and variables
...
//Canvas code comes from W3Schools: https://www.w3schools.com/html/html5_canvas.asp
const canvas = document.getElementById("myCanvas");
let barHeight = 0;

function draw(counter) {
  //Background
  //Fill code comes from W3Schools: https://www.w3schools.com/graphics/canvas_fill_stroke.asp
  const back = canvas.getContext("2d");
  back.fillStyle = "rgb(245, 245, 245)";
  back.fillRect(0, 0, 500, 500);

  //All of the rain
  //Gradient code comes from W3Schools: https://www.w3schools.com/graphics/canvas_gradients.asp
  ...
  //Code for the middle temperature bar, turns blue and goes down when negative, turns red and goes up when positive
  ...
  //Canvas text code comes from W3Schools: https://www.w3schools.com/graphics/canvas_text_alignment.asp https://www.w3schools.com/graphics/canvas_text.asp
  //Text that describes the month, temperature and precipitation level
  ...
  //Creates the little black bar in the middle to signify 0 degrees Celsius
